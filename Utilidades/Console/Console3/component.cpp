...
//*****************************************************************************
clb::Component::Component():Graphical(),
	m_top(0),
	m_left(0),
	m_right(0),
	m_bottom(0),
...
{
	paint();
	DS_("Component(label, x1, x2, y1, y2, cor)...")
}
//*****************************************************************************
void clb::Component::paint() {
	int   len = strlen(m_label);
	float startLine   = (((m_right-m_left)-len)/2)+m_left;
	float startColumn = (((m_bottom-m_top)-1)/2)+m_top;
	gotoxy(0, 0);
