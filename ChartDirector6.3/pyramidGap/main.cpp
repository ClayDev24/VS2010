...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "pyramidgap0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidgap1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidgap2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidgap3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidgap4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidgap5.png", NULL, NULL, SW_SHOWDEFAULT);
