...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "contourinterpolate0.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "contourinterpolate1.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "contourinterpolate2.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "contourinterpolate3.jpg", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
