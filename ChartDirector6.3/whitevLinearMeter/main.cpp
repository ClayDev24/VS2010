...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "whitevlinearmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitevlinearmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitevlinearmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitevlinearmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitevlinearmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitevlinearmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
