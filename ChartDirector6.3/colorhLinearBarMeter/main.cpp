...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "colorhlinearmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorhlinearmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorhlinearmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorhlinearmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorhlinearmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorhlinearmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
