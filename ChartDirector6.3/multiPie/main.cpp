...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "multipie0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "multipie1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "multipie2.png", NULL, NULL, SW_SHOWDEFAULT);
