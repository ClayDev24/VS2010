...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "gapbar0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "gapbar1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "gapbar2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "gapbar3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "gapbar4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "gapbar5.png", NULL, NULL, SW_SHOWDEFAULT);
