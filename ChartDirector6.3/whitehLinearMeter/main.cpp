...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "whitehlinearmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehlinearmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehlinearmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehlinearmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
