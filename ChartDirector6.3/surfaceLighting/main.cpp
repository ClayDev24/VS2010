...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "surfacelighting0.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacelighting1.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacelighting2.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacelighting3.jpg", NULL, NULL, SW_SHOWDEFAULT);
