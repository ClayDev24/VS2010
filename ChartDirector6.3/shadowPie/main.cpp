...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "shadowpie0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "shadowpie1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "shadowpie2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "shadowpie3.png", NULL, NULL, SW_SHOWDEFAULT);
