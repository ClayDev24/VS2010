...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "colorvbarmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvbarmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvbarmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvbarmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvbarmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvbarmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
