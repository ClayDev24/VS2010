...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "pyramidrotation0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidrotation1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidrotation2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidrotation3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidrotation4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidrotation5.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidrotation6.png", NULL, NULL, SW_SHOWDEFAULT);
