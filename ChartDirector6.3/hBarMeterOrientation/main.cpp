...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "hbarmeterorientation0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "hbarmeterorientation1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "hbarmeterorientation2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "hbarmeterorientation3.png", NULL, NULL, SW_SHOWDEFAULT);
