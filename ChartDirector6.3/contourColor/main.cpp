...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "contourcolor0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "contourcolor1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "contourcolor2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "contourcolor3.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
