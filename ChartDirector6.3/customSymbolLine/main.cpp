...
int main(int argc, char *argv[])
{
	...
	double data2[] = {000, 2500, 000, 2500, 000, 2500, 000, 2500};
    ...
    layer->addDataSet(DoubleArray(data2, (int)(sizeof(data2) / sizeof(data2[0]))), 0x40cf40,
        "Computers2")->setDataSymbol("small_computer2.png");
	...
	ShellExecute(NULL, "open", "customsymbolline.png", NULL, NULL, SW_SHOWDEFAULT);
