...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "surfaceshading0.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfaceshading1.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfaceshading2.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfaceshading3.jpg", NULL, NULL, SW_SHOWDEFAULT);
