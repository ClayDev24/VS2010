...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "threeddepthpie0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddepthpie1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddepthpie2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddepthpie3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddepthpie4.png", NULL, NULL, SW_SHOWDEFAULT);
