...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "colorvlinearmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvlinearmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvlinearmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvlinearmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvlinearmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorvlinearmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
