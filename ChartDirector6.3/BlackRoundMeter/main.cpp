...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "blackroundmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackroundmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackroundmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackroundmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackroundmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackroundmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
