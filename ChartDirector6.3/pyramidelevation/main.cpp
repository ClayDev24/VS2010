...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "pyramidelevation0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidelevation1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidelevation2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidelevation3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidelevation4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidelevation5.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pyramidelevation6.png", NULL, NULL, SW_SHOWDEFAULT);
