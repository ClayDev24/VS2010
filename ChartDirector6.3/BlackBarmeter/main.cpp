...
void createChart(int chartIndex, const char *filename)
{
    ...
    LinearMeter *m = new LinearMeter(260, 580, 0x000000);
...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "blackhbarmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhbarmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhbarmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhbarmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhbarmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhbarmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
