...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "blackhlinearmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhlinearmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhlinearmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhlinearmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhlinearmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackhlinearmeter6.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
