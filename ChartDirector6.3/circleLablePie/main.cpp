...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "circlelabelpie0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "circlelabelpie1.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
