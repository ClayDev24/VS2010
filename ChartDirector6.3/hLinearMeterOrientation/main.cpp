...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "hlinearmeterorientation0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "hlinearmeterorientation1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "hlinearmeterorientation2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "hlinearmeterorientation3.png", NULL, NULL, SW_SHOWDEFAULT);
