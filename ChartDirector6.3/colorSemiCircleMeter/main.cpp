...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "colorsemicirclemeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorsemicirclemeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorsemicirclemeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorsemicirclemeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorsemicirclemeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "colorsemicirclemeter5.png", NULL, NULL, SW_SHOWDEFAULT);
