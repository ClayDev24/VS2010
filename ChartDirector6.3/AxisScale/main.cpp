...
void createChart(int chartIndex, const char *filename)
{
    ...
    XYChart *c = new XYChart(600, 690);

    // Set the plot area at (30, 20) and of size 140 x 140 pixels
    c->setPlotArea(30, 20, 540, 540);
...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "axisscale0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "axisscale1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "axisscale2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "axisscale3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "axisscale4.png", NULL, NULL, SW_SHOWDEFAULT);
