...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "donutshading0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutshading1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutshading2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutshading3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutshading4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutshading5.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutshading6.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
