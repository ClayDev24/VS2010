...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "blackvbarmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvbarmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvbarmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvbarmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvbarmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvbarmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
