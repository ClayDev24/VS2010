...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "blacksemicirclemeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blacksemicirclemeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blacksemicirclemeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blacksemicirclemeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blacksemicirclemeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blacksemicirclemeter5.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
