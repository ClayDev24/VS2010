...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "squareameter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "squareameter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "squareameter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "squareameter3.png", NULL, NULL, SW_SHOWDEFAULT);
