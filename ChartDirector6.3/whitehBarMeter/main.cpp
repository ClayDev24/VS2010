...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "whitehbarmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehbarmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehbarmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehbarmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehbarmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitehbarmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
