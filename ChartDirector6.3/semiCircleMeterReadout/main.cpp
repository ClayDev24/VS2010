...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "semicirclemeterreadout0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "semicirclemeterreadout1.png", NULL, NULL, SW_SHOWDEFAULT);
