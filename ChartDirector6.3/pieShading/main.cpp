...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "pieshading0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pieshading1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pieshading2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pieshading3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pieshading4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "pieshading5.png", NULL, NULL, SW_SHOWDEFAULT);
