...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "whitesemicirclemeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitesemicirclemeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitesemicirclemeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitesemicirclemeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitesemicirclemeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "whitesemicirclemeter5.png", NULL, NULL, SW_SHOWDEFAULT);
