...
void createChart(int chartIndex, const char *filename)
{
    ...
    XYChart *c = new XYChart(670, 670);

    // Set the plot area at (40, 32) and of size 200 x 200 pixels
    PlotArea *plotarea = c->setPlotArea(40, 32, 600, 600);
...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "background0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "background1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "background2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "background3.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
