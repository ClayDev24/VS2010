...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "donutwidth0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutwidth1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutwidth2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutwidth3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "donutwidth4.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
