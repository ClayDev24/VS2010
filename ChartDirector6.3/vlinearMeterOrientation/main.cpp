...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "vlinearmeterorientation0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "vlinearmeterorientation1.png", NULL, NULL, SW_SHOWDEFAULT);
