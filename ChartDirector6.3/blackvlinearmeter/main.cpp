...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "blackvlinearmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvlinearmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvlinearmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvlinearmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvlinearmeter4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "blackvlinearmeter5.png", NULL, NULL, SW_SHOWDEFAULT);
    return 0;
}
