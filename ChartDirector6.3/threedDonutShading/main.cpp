...
#include "ChartDirector63\chartdir.h"
...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "threeddonutshading0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddonutshading1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddonutshading2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddonutshading3.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddonutshading4.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddonutshading5.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddonutshading6.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "threeddonutshading7.png", NULL, NULL, SW_SHOWDEFAULT);
