...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "vbarmeterorientation0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "vbarmeterorientation1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "vbarmeterorientation2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "vbarmeterorientation3.png", NULL, NULL, SW_SHOWDEFAULT);
