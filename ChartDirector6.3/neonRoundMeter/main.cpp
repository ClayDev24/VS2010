...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "neonroundmeter0.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "neonroundmeter1.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "neonroundmeter2.png", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "neonroundmeter3.png", NULL, NULL, SW_SHOWDEFAULT);
