...
int main(int argc, char *argv[])
{
	...
	ShellExecute(NULL, "open", "surfacewireframe0.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacewireframe1.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacewireframe2.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacewireframe3.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacewireframe4.jpg", NULL, NULL, SW_SHOWDEFAULT);
	ShellExecute(NULL, "open", "surfacewireframe5.jpg", NULL, NULL, SW_SHOWDEFAULT);
