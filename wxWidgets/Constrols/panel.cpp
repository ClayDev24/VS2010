       ...
       : wxPanel(_frame, wxID_ANY, wxPoint(x, y), wxSize(w, h) )
{
    ...
    m_choice       = new Choice( panel, ID_CHOICE, wxPoint(10,10), wxDefaultSize, 5, choices );
    m_choiceSorted = new Choice( panel, ID_CHOICE_SORTED, wxPoint(10,70), wxSize(120,wxDefaultCoord),
                                   5, choices, wxCB_SORT );
    ...
    // ------------------------------------------------------------------------
    panel = new wxPanel(m_book);
    m_combo = new ComboBox( panel, ID_COMBO, wxT("This"),
    ...
    m_radio = new wxRadioBox(panel, ID_RADIOBOX, wxT("T&his"),
                             ...
                             1, wxRA_SPECIFY_COLS );
    RadioBox* mybox = new RadioBox(panel, ID_RADIOBOX2, wxT("&That"),
