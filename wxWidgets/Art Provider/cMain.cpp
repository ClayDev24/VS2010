...
bool App::OnInit() {
    ...
    MyFrame *frame = new MyFrame(wxT("wxArtProvider sample"), wxPoint(50, 50), wxSize(450, 340));
    frame->Show(true);
    return true;
}
...
void MyFrame::OnAbout(wxCommandEvent& WXUNUSED(event)) {
    ...
    wxMessageBox(msg, wxT("About wxArtProvider sample"), wxOK | wxICON_INFORMATION, this);
}
