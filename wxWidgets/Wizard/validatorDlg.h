...
class FrameValidator : public wxFrame {
	wxTextCtrl* m_textCtrl;
    void OnRunWizard(wxCommandEvent& evt);

public:
    FrameValidator(const wxString& title);

private:
    wxDECLARE_EVENT_TABLE();
};

wxBEGIN_EVENT_TABLE(FrameValidator, wxFrame)
    EVT_MENU(ID_WIZARD, FrameValidator::OnRunWizard)
wxEND_EVENT_TABLE()
//******************************************************
FrameValidator::FrameValidator(const wxString& title)
...
// is activated
void FrameValidator::OnRunWizard(wxCommandEvent& evt) {
